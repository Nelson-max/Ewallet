          ...
          <div className="flex items-center justify-start">
            ...
            >
              <img
                ...
                alt="Windster Logo"
              />
              <span className="self-center whitespace-nowrap">E-wallet</span>
            </a>
          ...
          <div className="flex-1 flex flex-col pt-5 pb-4 overflow-y-auto">
            <div className="flex-1 px-3 bg-white divide-y space-y-1">
              <ul className="space-y-2 pb-2">
                ...
                <li>
                  <Link to="https://demo.themesberg.com/windster-pro/kanban/"
                    target="_blank"
                ...
                <li>
                  <Link to="https://demo.themesberg.com/windster-pro/mailing/inbox/"
                    target="_blank"
                    className="text-base text-gray-900 font-normal rounded-lg hover:bg-gray-100 flex items-center p-2 group "
                  >
                    <svg
                ...
                <li>
                  <Link to="https://demo.themesberg.com/windster/users/list/"
                    className="text-base text-gray-900 font-normal rounded-lg hover:bg-gray-100 flex items-center p-2 group "
                  >
                    <svg
                      className="w-6 h-6 text-gray-500 flex-shrink-0 group-hover:text-gray-900 transition duration-75"
                ...
                <li>
                  <Link to="https://demo.themesberg.com/windster/e-commerce/products/"
                    className="text-base text-gray-900 font-normal rounded-lg hover:bg-gray-100 flex items-center p-2 group "
                  >
                    <svg
                      className="w-6 h-6 text-gray-500 flex-shrink-0 group-hover:text-gray-900 transition duration-75"
                ...
                <li>
                  <Link to="https://demo.themesberg.com/windster/authentication/sign-in/"
                    className="text-base text-gray-900 font-normal rounded-lg hover:bg-gray-100 flex items-center p-2 group "
                  >
                    <svg
                      className="w-6 h-6 text-gray-500 flex-shrink-0 group-hover:text-gray-900 transition duration-75"
                ...
                <li>
                  <Link to="https://demo.themesberg.com/windster/authentication/sign-up/"
                    className="text-base text-gray-900 font-normal rounded-lg hover:bg-gray-100 flex items-center p-2 group "
                  >
                    <svg
                      className="w-6 h-6 text-gray-500 flex-shrink-0 group-hover:text-gray-900 transition duration-75"
              ...
              <div className="space-y-2 pt-2">
                <Link to="https://demo.themesberg.com/windster/pricing/"
                ...
                <Link to="https://flowbite.com/docs/getting-started/introduction/"
                  target="_blank"
                  className="text-base text-gray-900 font-normal rounded-lg hover:bg-gray-100 group transition duration-75 flex items-center p-2"
                >
                  <svg
                ...
                <Link to="https://flowbite.com/docs/components/alerts/"
                  target="_blank"
                  className="text-base text-gray-900 font-normal rounded-lg hover:bg-gray-100 group transition duration-75 flex items-center p-2"
                >
                  <svg
                ...
                <Link to="https://github.com/themesberg/windster-tailwind-css-dashboard/issues"
                  target="_blank"
                  className="text-base text-gray-900 font-normal rounded-lg hover:bg-gray-100 group transition duration-75 flex items-center p-2"
                >
                  <svg
